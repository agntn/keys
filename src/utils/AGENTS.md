...
| `bitcoin.ts`        |       | bitcoin, litecoin, bitcoingold, bitcoincash, bitcoinsv, dogecoin | Keys and message serialization for all six; addresses and HD purpose inference for three |
