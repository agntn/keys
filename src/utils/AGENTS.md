...
| `bitcoin.ts`        |       | bitcoin, litecoin, bitcoingold, bitcoincash, bitcoinsv, dash, dogecoin, zcash | Keys and message serialization for all eight; base58 P2PKH for three, CashAddr for one, full addresses and HD purpose inference for three |
| `cashaddr.ts`       |       | bitcoincash                                                                   | CashAddr encode and decode with the Bitcoin Cash Node version byte rules                                                                  |
