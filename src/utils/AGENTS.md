...
| `bitcoin.ts`        |       | bitcoin, litecoin, bitcoingold, bitcoincash, bitcoinsv | Keys and message serialization for all five; addresses and HD purpose inference for three |
