...
| `bitcoin.ts`        |       | bitcoin, litecoin, bitcoingold, bitcoincash, bitcoinsv, dash, dogecoin, zcash | Keys and message serialization for all eight; base58 P2PKH for three, full addresses and HD purpose inference for three |
