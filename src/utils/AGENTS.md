...
| `bitcoin.ts`        |       | bitcoin, litecoin, bitcoingold, bitcoincash, bitcoinsv, dash, dogecoin | Keys and message serialization for all seven; addresses and HD purpose inference for three |
