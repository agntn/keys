...
| `bitcoin.ts`        |       | bitcoin, litecoin, bitcoingold, bitcoincash, bitcoinsv, dash, dogecoin, zcash | Keys and message serialization for all eight; addresses and HD purpose inference for three |
