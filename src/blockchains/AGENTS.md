...
- **Derivation paths** - `getDerivationPath` is BIP44 on the base class; Solana, Stellar, Aptos and Sui override it with the hardened SLIP-10 shape their wallets use, cut at each chain's depth, Cardano with the CIP-1852 path
