...
Bitcoin and Litecoin have five formats, Cardano three, Sui uses the argument to name the curve. Bitcoin Cash, Bitcoin SV and Decred have one and throw if you ask for another. Ethereum, Base, TRON, Solana, Stellar, and Aptos have one format and ignore the argument.
