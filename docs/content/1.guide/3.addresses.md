...
Bitcoin and Litecoin have five formats, Cardano three, Sui uses the argument to name the curve. Decred has one and throws if you ask for another. Ethereum, Base, TRON, Solana, Stellar, and Aptos have one format and ignore the argument.
