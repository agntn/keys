...
const TAGLINE =
  "Keys to addresses to signatures on seventeen chains. From a mnemonic or from nothing at all. Nothing leaves the process.";
  ...
  >
    <div
      ...
      style="
        background-image: radial-gradient(
          ellipse at top,
          rgba(111, 208, 247, 0.18) 0%,
          rgba(111, 208, 247, 0.05) 45%,
          transparent 70%
        );
      "
    />
    ...
    <div class="flex items-center justify-between w-full">
      <div class="flex items-center">
        <div
          ...
          :style="{
            ...
            color: index === 0 ? '#6fd0f7' : '#a5b0bc',
            backgroundColor: '#11141a',
            border: index === 0 ? '1px solid rgba(111, 208, 247, 0.5)' : '1px solid #262c35',
            lineHeight: '36px',
            whiteSpace: 'nowrap',
          }"
        >
      ...
      <p
        ...
        style="font-family: &quot;Space Mono&quot;; color: #6d7884; white-space: nowrap"
      >
        keys.agntn.dev
      </p>
    </div>
