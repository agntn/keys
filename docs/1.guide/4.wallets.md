...
::warning
@agntn/keys is primarily a tool for interacting with blockchain protocols. It does not currently implement secure key storage or HD wallet functionality. For production applications, consider using additional security measures.
::
