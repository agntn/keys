...
- Keep wallet SDKs out of the suite. Freeze what ethers, web3.js or a chain SDK produces as vectors in `fixtures.ts`, with the library and version in the JSDoc; `../test-integration/` runs the live comparison.
