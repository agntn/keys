...
export default function keysExtension(pi: ExtensionAPI) {
  ...
  pi.registerTool({
    ...
    promptGuidelines: [
      "Provide a chain name (bitcoin, bitcoincash, litecoin, decred, ethereum, base, solana, stellar, aptos, tron, sui, cardano)",
  ...
  pi.registerTool({
    ...
    promptGuidelines: [
      ...
      "Common paths: Bitcoin m/44'/0'/0'/0/0 (legacy), m/49'/0'/0'/0/0 (p2sh), m/84'/0'/0'/0/0 (segwit), m/86'/0'/0'/0/0 (taproot); Bitcoin Cash m/44'/145'/0'/0/0; Ethereum m/44'/60'/0'/0/0; Solana m/44'/501'/0'/0'; Stellar m/44'/148'/0'; Aptos m/44'/637'/0'/0'/0'; Sui m/44'/784'/0'/0'/0'",
  ...
  pi.registerTool({
    ...
    promptGuidelines: [
      ...
      "Bitcoin and Litecoin each use their own message preamble; Bitcoin Cash signs with Bitcoin's",
