...
Pi coding agent extension exposing the [`@agntn/keys`](../../README.md) library as 19 agent tools for key generation, WIF conversion, BIP39 generation, entropy encoding, inspection and recovery, address derivation, validation, signing, and BIP44 paths across 12 blockchains (Bitcoin, Bitcoin Cash, Litecoin, Decred, Ethereum, Base, Solana, Stellar, Aptos, TRON, SUI, Cardano).
