...
🔑 Keys, addresses and signatures for thirteen chains, from a mnemonic or from nothing at all. Bitcoin gets its five address types, Solana gets ed25519, your agent gets 19 tools, and none of it should ever meet real money.
...
- ⛓️ **Thirteen chains, one interface.** Bitcoin, Bitcoin Cash, Bitcoin SV, Litecoin, Decred, Ethereum, Base, Solana, Stellar, Aptos, Cardano, Sui and TRON, each a class with the same methods on it.
